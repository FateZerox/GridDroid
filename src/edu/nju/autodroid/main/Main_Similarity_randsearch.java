 ...
 */
public class Main_Similarity_randsearch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<WindowGraph> graphList1 = getGraphsFromDir(strategyFolder1);
...
//        }
        ...
        if(true){
            int i = (int)Math.random()*graphList1.size();
...
//                    Double value = (Double) map1.get(key);
//                    simi_sum1 += value;
//                }
//                for(Object key:map2.keySet()){
//                    Double value = (Double) map2.get(key);
//                    simi_sum2 += value;
//                }
//                if ((simi_sum1/graph1.getEdgeCount()<0.75) && (simi_sum2/graph2.getEdgeCount()<0.75)){
//                    bw.write(graph1.fileName + " " + graph2.fileName + " " + 0.0 + " " +0.0+" "+ graph1.getEdgeCount() + " " + graph2.getEdgeCount()+" "+groupcount(graph1.fileName,strategyFolder1)+" "+groupcount(graph2.fileName,strategyFolder2));
//                    bw.newLine();
//                    continue;
//                }
                simDic.clear();
...
//                            }
            ...
            for(String s:g.vertexMap.keySet()){
                ...
                if(nodecount<=20){
                    g.groupnodelist[0] += 1;
                }else if (nodecount>20 && nodecount <= 50){
                    g.groupnodelist[1] += 1;
                }else if (nodecount>50 && nodecount <= 90){
                    g.groupnodelist[2] += 1;
                }else{
                    g.groupnodelist[3] += 1;
                }
